...
def show_content(event):
    ...
    if selection:
        ...
        if selected_item == "Preface":
            text_widget.insert(tk.END, preface_text)
        elif selected_item == "Tablet 1":
            text_widget.insert(tk.END, tablet_1_text)
        elif selected_item == "Tablet 2":
            text_widget.insert(tk.END, tablet_2_text)
        elif selected_item == "Tablet 3":
            text_widget.insert(tk.END, tablet_3_text)
        elif selected_item == "Tablet 4":
            text_widget.insert(tk.END, tablet_4_text)
        elif selected_item == "Tablet 5":
            text_widget.insert(tk.END, tablet_5_text)
        elif selected_item == "Tablet 6":
            text_widget.insert(tk.END, tablet_6_text)
        elif selected_item == "Tablet 7":
            text_widget.insert(tk.END, tablet_7_text)
        elif selected_item == "Tablet 8":
            text_widget.insert(tk.END, tablet_8_text)
        elif selected_item == "Tablet 9":
            text_widget.insert(tk.END, tablet_9_text)
        elif selected_item == "Tablet 10":
            text_widget.insert(tk.END, tablet_10_text)
        elif selected_item == "Tablet 11":
            text_widget.insert(tk.END, tablet_11_text)
        elif selected_item == "Tablet 12":
            text_widget.insert(tk.END, tablet_12_text)
        elif selected_item == "Tablet 13":
            text_widget.insert(tk.END, tablet_13_text)
        elif selected_item == "Tablet 14":
            text_widget.insert(tk.END, tablet_14_text)
        elif selected_item == "Tablet 15":
            text_widget.insert(tk.END, tablet_15_text)
        else:
            text_widget.insert(tk.END, f"Content for {selected_item} will be displayed here.")
        text_widget.config(state='disabled')
        text_widget.see("1.0")  # Scroll to the top

# Function to show main window
def show_main_window():
    main_window = tk.Tk()
    main_window.title("The Emerald Tablets of Thoth")
    main_window.geometry("1200x800")
    main_window.configure(bg='darkgreen')

    # Create a frame for the contents
    contents_frame = tk.Frame(main_window, bg='darkgreen')
    contents_frame.pack(fill='both', expand=True)

    # Create a label for the title
    title_label = tk.Label(contents_frame, text="The Emerald Tablets of Thoth", font=("Helvetica", 24), bg='darkgreen', fg='white')
    title_label.pack(pady=20)

    # Create a frame for the listbox and text widget
    content_frame = tk.Frame(contents_frame, bg='darkgreen')
    content_frame.pack(fill='both', expand=True, padx=20, pady=20)

    # Create a listbox for the contents
    global contents_listbox
    contents_listbox = tk.Listbox(content_frame, font=("Helvetica", 16), bg='darkgreen', fg='white', width=20)
    contents_listbox.pack(side='left', fill='y', padx=(0, 20))

    # Create a text widget for displaying content
    global text_widget
    text_widget = scrolledtext.ScrolledText(content_frame, font=("Helvetica", 12), bg='darkgreen', fg='white', wrap=tk.WORD)
    text_widget.pack(side='right', fill='both', expand=True)

    # Add contents to the listbox
    contents_listbox.insert(tk.END, "Preface")
    for i in range(1, 16):
        contents_listbox.insert(tk.END, f"Tablet {i}")

    # Bind selection event
    contents_listbox.bind('<<ListboxSelect>>', show_content)

    main_window.mainloop()

# Tablet 1 text
tablet_1_text = """Tablet I: The History of Thoth, The Atlantean
...
# Tablet 2 text
tablet_2_text = """Tablet II: The Halls of Amenti
...
# Tablet 3 text
tablet_3_text = """Tablet III: The Key of Wisdom
...
# Tablet 4 text
tablet_4_text = """Tablet IV: The Space Born
...
# Tablet 5 text
tablet_5_text = """Tablet V: The Dweller of Unal
...
# Tablet 6 text
tablet_6_text = """Tablet VI: The Key of Magic
...
# Tablet 7 text
tablet_7_text = """Tablet VII: The Seven Lords
...
# Tablet 8 text
tablet_8_text = """Tablet VIII: The Key of Mysteries
...
# Tablet 9 text
tablet_9_text = """Tablet IX: The Key of Freedom of Space
...
# Tablet 10 text
tablet_10_text = """Tablet X: The Key of Time
...
# Tablet 11 text
tablet_11_text = """Tablet XI: The Key to Above and Below
...
# Tablet 12 text
tablet_12_text = """Tablet XII: The Law of Cause and Effect and The Key of Prophecy
...
# Tablet 13 text
tablet_13_text = """Tablet XIII: The Keys of Life and Death
...
# Tablet 14 text
tablet_14_text = """Tablet XIV: Atlantis
...
# Tablet 15 text
tablet_15_text = """Tablet XV: Secret of Secrets
...
# Preface text
preface_text = """The Emerald Tablets of Thoth
...
password_window.configure(bg='darkgreen')

# Create a label and entry for the password
password_label = tk.Label(password_window, text="Enter Password:", font=("Helvetica", 14), bg='darkgreen', fg='white')
password_label.pack(pady=10)
password_entry = tk.Entry(password_window, show='*', font=("Helvetica", 14))
password_entry.pack(pady=10)

# Create a button to submit the password
submit_button = tk.Button(password_window, text="Submit", font=("Helvetica", 14), command=check_password)
